...
class TestSciXML(unittest.TestCase):
    ...
    def runFirstSentence(self, sentences):
        ...
        self.assertEqual(u'A series of transient interconvertible protonated and deprotonated mononuclear Fe(iii) peroxo species are derived from the pH dependent reaction of dihydrogen peroxide with mononuclear iron(ii) or iron(iii) complexes of general formulation [Fe(Rtpen)X](A)n, n = 1, 2; X = Cl, Br; Rtpen = N-alkyl-N,N\u2032,N\u2032-tris(2-pyridylmethyl)ethane-1,2-diamine, alkyl = R = CH3CH2, CH3CH2CH2, HOCH2CH2, (CH3)2CH, C6H5, and C6H5CH2; A = ClO4, PF6.', firstSentence.content)
...
if __name__ == '__main__':
    unittest.main()
    #doc = SciXML.parse(TestSciXML.testFile)
